...
localparam real ACTUAL_RATE  =  1000.0   ; 
...
initial begin
force ddr3_test_top_tb.i_mem[gen_mem].mem_core.disable_tdstdh = 1'b1;
force ddr3_test_top_tb.i_mem[gen_mem].mem_core.disable_trfc_max = 1'b1;
@ (posedge dfi_init_complete);
force ddr3_test_top_tb.i_mem[gen_mem].mem_core.disable_tdstdh = 1'b0;
force ddr3_test_top_tb.i_mem[gen_mem].mem_core.disable_trfc_max = 1'b0;
end    
...
#10 ddr_rstn = 1'b0;
#50 ddr_rstn = 1'b1;
#10000 force ddr3_test_top_tb.u_ddr.dbg_temp_rd = 1'b1 ;
#100000 force ddr3_test_top_tb.u_ddr.dbg_temp_rd = 1'b0 ;
#10000  force ddr3_test_top_tb.u_ddr.dbg_volt_rd = 1'b1 ;
...
initial begin
    ...
    $display("%t The Phy dll_90_bin is %h",$time,u_ddr.I_ips_ddr_top.u_ddrphy_top.ddrphy_slice_top.dll_90_bin);
    ...
    $display("%t The Phy dq_idly_bin is %h",$time,u_ddr.I_ips_ddr_top.u_ddrphy_top.ddrphy_slice_top.dq_idly_bin);
    ...
    $display("%t The Phy dqs_even_win is %h",$time,u_ddr.I_ips_ddr_top.u_ddrphy_top.ddrphy_slice_top.dqs_even_win);
    $display("%t The Phy dqs_odd_win is %h",$time,u_ddr.I_ips_ddr_top.u_ddrphy_top.ddrphy_slice_top.dqs_odd_win);   
    ...
    $display("%t The Phy wl_p_dll_bin is %h",$time,u_ddr.I_ips_ddr_top.u_ddrphy_top.ddrphy_slice_top.wl_p_dll_bin);
    $display("%t The Phy dq_odly_bin is %h",$time,u_ddr.I_ips_ddr_top.u_ddrphy_top.ddrphy_slice_top.dq_odly_bin);
    $display("%t The Phy wr_dq_win is %h",$time,u_ddr.I_ips_ddr_top.u_ddrphy_top.ddrphy_slice_top.wr_dq_win);
