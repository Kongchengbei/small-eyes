...
initial begin
force i_mem[gen_mem].mem_core.disable_tdstdh = 1'b1;
force i_mem[gen_mem].mem_core.disable_trfc_max = 1'b1;
@ (posedge dfi_init_complete);
force i_mem[gen_mem].mem_core.disable_tdstdh = 1'b0;
force i_mem[gen_mem].mem_core.disable_trfc_max = 1'b0;
end    
...
#10 ddr_rstn = 1'b0;
#50 ddr_rstn = 1'b1;
#10000 force u_ddr.dbg_temp_rd = 1'b1 ;
#100000 force u_ddr.dbg_temp_rd = 1'b0 ;
#10000  force u_ddr.dbg_volt_rd = 1'b1 ;
...
initial 
begin
 $usdbDumpfile("ddr3_test_top_tb_uvs.usdb");
 $usdbDumpvars(0,"ddr3_test_top_tb_uvs");
end
