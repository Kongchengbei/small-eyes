...
//DEBUG
wire  [74:0]                   debug_data_group        ;
wire  [23:0]                   dbg_slice_state_group   ;
wire  [63:0]                   dq_idly_bin_group       ;
wire  [63:0]                   dq_odly_bin_group       ;
...
wire [75*MEM_DQS_WIDTH -1:0] debug_data                ;
wire [4*MEM_DQS_WIDTH +16:0] dbg_slice_status          ;
wire [24*MEM_DQS_WIDTH -1:0] dbg_slice_state           ;
...
wire [8*8*MEM_DQS_WIDTH-1:0] dq_idly_bin               ;
wire [8*8*MEM_DQS_WIDTH-1:0] dq_odly_bin               ;
...
//assign init_samp_position_odd[63:3] = ctrl_bus_11[31:0];

//control bus 1
parameter DFT_CTRL_BUS_12            = 32'h00_00_00_00;
//assign init_samp_position_odd[31:0]  = ctrl_bus_1[31:0];
...
assign status_bus_90 = {8'b0,dbg_slice_state_group};
assign status_bus_91 = debug_data_group[32*0 +: 32];    
assign status_bus_92 = debug_data_group[32*1 +: 32];    
assign status_bus_93 = {21'b0,debug_data_group[74:64]}; 
...
assign status_bus_9e = dq_idly_bin_group[32*0 +: 32];
assign status_bus_9f = dq_idly_bin_group[32*1 +: 32];
assign status_bus_a0 = dq_odly_bin_group[32*0 +: 32];
assign status_bus_a1 = dq_odly_bin_group[32*1 +: 32];
...
state_group_mux_v1_0 #(
    ...
    .dq_idly_bin_group      (dq_idly_bin_group      ), 
    .dq_odly_bin_group      (dq_odly_bin_group      ), 
