...
//////////////////////////////////////////////////////////////////////////////
module ipm2l_spram_v1_8_DataRAM #(
...
localparam RST_VAL_EN = 1 ; // @IPC bool
`include "DataRAM_Reset_Value.v"
    ...
    for(gen_j=0;gen_j<ADDR_LOOP_NUM;gen_j=gen_j+1) begin:ADDR_LOOP
        ...
        //write data
            ...
            GTP_DRM18K_E1 # (
                ...
                .RSTA_VAL                 ( c_RSTA_VAL[gen_i*18 +: 18] ),
                .RSTB_VAL                 ( c_RSTB_VAL[gen_i*18 +: 18] ),
